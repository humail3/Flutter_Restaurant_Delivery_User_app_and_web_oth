...
class SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    _onConnectivityChanged = Connectivity().onConnectivityChanged.listen((List<ConnectivityResult> results) {
      if (!firstTime) {
        bool isNotConnected = !results.any((result) => result == ConnectivityResult.wifi || result == ConnectivityResult.mobile);
        ...
        if (isNotConnected) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            content: Text('connected'.tr, textAlign: TextAlign.center),
          ));
          _route();  // Call your routing function if connected
        }
      }
      firstTime = false;
    });
